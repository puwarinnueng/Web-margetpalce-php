...
<head>
  <meta charset="utf-8">
  <title>MSI GEFORCE RTX 2060 SUPER GAMING X</title>
</head>
    ...
    <div class="row row1">
      <div class="col-md-8">
        <div1 class="card_product_detail">
          ...
          <div class="infos">
            <h1 class="name_detail">GRAPHIC CARD (การ์ดแสดงผล) MSI GEFORCE RTX 2060 SUPER GAMING X</h1><br>
            <p>- แบรนด์ MSI </p>
            <p>- GRAPHIC ENGINE : GEFORCE RTX 2060 SUPER</p>
            ...
            <h3 class="price_detail"> ราคา 14,000 บาท</h3>
            <br>
            <p class="availbilty">AVAILABILITY : In Stock</p>
            <br>
            <button class="buttons_detail"><a href="<?php echo site_url('cart/gpu_msi_2060'); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i> เพิ่มใส่รถเข็น </a></button>
          </div>
      </div>
