...
<head>
  <meta charset="utf-8">
  <title>INTEL LGA1200 CORE I9-10900K 3.7 GHz</title>
</head>
    ...
    <div class="row row1">
      <div class="col-md-8">
        <div1 class="card_product_detail">
          ...
          <div class="infos">
            <h1 class="name_detail">CPU (ซีพียู) INTEL LGA1200 CORE I9-10900K 3.7 GHz </h1><br>
            <p>- แบรนด์ INTEL </p>
            <p>- CORES : 10</p>
            <p>- THREADS : 20</p>
            ...
            <h3 class="price_detail"> ราคา 19,500 บาท</h3>
            <br>
            <p class="availbilty">AVAILABILITY : In Stock</p>
            <br>
            <button class="buttons_detail"><a href="<?php echo site_url('cart/cpu_i9'); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i> เพิ่มใส่รถเข็น </a></button>
          </div>
      </div>
