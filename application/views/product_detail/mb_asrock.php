...
<head>
  <meta charset="utf-8">
  <title>LGA1200 ASROCK Z490 TAICHI</title>
</head>
    ...
    <div class="row row1">
      <div class="col-md-8">
        <div1 class="card_product_detail">
          ...
          <div class="infos">
            <h1 class="name_detail">MAINBOARD (เมนบอร์ด) 1200 ASROCK Z490 TAICHI </h1><br>
            <p>- แบรนด์ ASROCK </p>
            <p>- LGA 1200 socket : รองรับหน่วยประมวลผล Intel® Core™ 10th-gen</p>
            <p>- SOCKET : 1200</p>
            <p>- CHIPSET : INTEL Z490</p>
            <p>- MEMORY : 4 X DDR4 DIMM</p>
            <br>
            <h4 class="guarantee"><i class="fa fa-certificate" aria-hidden="true" style="font-size:20px;color:#FACC2E"></i> ประกัน 3 ปี</h4><br><br>
            <h3 class="price_detail"> ราคา 12,600 บาท</h3>
            <br>
            <p class="availbilty">AVAILABILITY : In Stock</p>
            <br>
            <button class="buttons_detail"><a href="<?php echo site_url('cart/mb_asrock'); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i> เพิ่มใส่รถเข็น </a></button>
          </div>
      </div>
        ...
        <div class="discription">
          ...
          <div class="content_discription">
            <table class="discription_table">
              ...
              <tr>
                <td>CPU </td>
                <td>Supports 10th Gen Intel® Core™ Processors and 11th Gen Intel® Core™ Processors (LGA1200)</td>
              </tr>
              <tr>
                <td>CPU Series </td>
                <td>Intel Celeron , Intel Core i3 , Intel Core i5 , Intel Core i7 , Intel Core i9 , Intel Pentium, Intel Pentium Gold</td>
              </tr>
              <tr>
                <td>Chipset </td>
                <td>Z490</td>
