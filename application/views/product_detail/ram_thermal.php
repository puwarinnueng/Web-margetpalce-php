...
<head>
  <meta charset="utf-8">
  <title>16GB (8GBX2) DDR4 BUS4000 THERMALTAKE TOUGHRAM RGB</title>
</head>
    ...
    <div class="row row1">
      <div class="col-md-8">
        <div1 class="card_product_detail">
          ...
          <div class="infos">
            <h1 class="name_detail">RAM (แรม) 16GB (8GBX2) DDR4 BUS4000 THERMALTAKE TOUGHRAM RGB </h1><br>
            <p>- แบรนด์ THERMALTAKE </p>
            <p>- CAPACITY: 16 GB</p>
            <p>- SPEED 4000 MHz</p>
            <p>- 8GB X 2</p>
            <br>
            <h4 class="guarantee"><i class="fa fa-certificate" aria-hidden="true" style="font-size:20px;color:#FACC2E"></i> ประกัน 3 ปี</h4><br><br>
            <h3 class="price_detail"> ราคา 5,000 บาท</h3>
            <br>
            <p class="availbilty">AVAILABILITY : In Stock</p>
            <br>
            <button class="buttons_detail"><a href="<?php echo site_url('cart/ram_thermal'); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i> เพิ่มใส่รถเข็น </a></button>
          </div>
      </div>
