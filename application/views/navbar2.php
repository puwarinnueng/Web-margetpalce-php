    ...
    <div class="container">
      ...
      <div class="row row2">
        <ul class="largenav pull-right">
          ...
          <li class="upper-links"><a class="links" href="http://clashhacks.in/">หน้าแรก</a></li>
          ...
          <li class="upper-links dropdown"><a class="links" href="http://clashhacks.in/">เงื่อนไข</a>
            <ul class="dropdown-menu">
              <li class="profile-li"><a class="profile-links" href="http://yazilife.com/">Link</a></li>
              <li class="profile-li"><a class="profile-links" href="http://hacksociety.tech/">Link</a></li>
              <li class="profile-li"><a class="profile-links" href="http://clashhacks.in/">Link</a></li>
          ...
          <li class="upper-links dropdown"><a class="links" href="http://clashhacks.in/">การรับประกัน</a>
            <ul class="dropdown-menu">
              <li class="profile-li"><a class="profile-links" href="http://yazilife.com/">Link</a></li>
              <li class="profile-li"><a class="profile-links" href="http://hacksociety.tech/">Link</a></li>
              <li class="profile-li"><a class="profile-links" href="http://clashhacks.in/">Link</a></li>
          ...
          <li class="upper-links"><a class="links" href="http://clashhacks.in/">เกี่ยวกับเรา</a></li>
